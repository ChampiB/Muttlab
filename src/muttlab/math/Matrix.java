...
public abstract class Matrix {
     ...
     */
    public abstract Matrix newEmptyMatrix(Integer numberOfRows, Integer numberOfColumns) throws Exception;
     ...
     */
    public abstract void set(Integer row, Integer column, Float value) throws Exception;
     ...
     * @throws Exception if the position is not valid.
     */
    public abstract Float get(Integer row, Integer column) throws Exception;
