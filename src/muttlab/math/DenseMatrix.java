...
public class DenseMatrix extends Matrix {
     ...
     * @throws Exception if the matrix size is not valid.
     */
    public DenseMatrix(Integer height, Integer width) throws Exception {
        if (height < 0 || width < 0)
            throw new Exception(MuttLabStrings.NOT_VALID_MATRIX_SIZE.toString());
        this.width = width;
        this.height = height;
     ...
     */
    public void set(Integer row, Integer column, Float value) throws Exception {
        if (!isValid(row, column))
            throw new Exception(MuttLabStrings.MATRIX_ELEMENT_DOES_NOT_EXIST.toString());
     ...
     * @throws Exception if the position is not valid.
     */
    public Float get(Integer row, Integer column) throws Exception {
        if (!isValid(row, column))
            throw new Exception(MuttLabStrings.MATRIX_ELEMENT_DOES_NOT_EXIST.toString());
     ...
     * @throws Exception if the size is not valid.
     */
    public DenseMatrix newEmptyMatrix(Integer numberOfRows, Integer numberOfColumns) throws Exception {
    ...
    public Matrix from(String s) throws Exception {
        try {
            ...
            throw new UserException(MuttLabStrings.NOT_VALID_MATRIX.toString());
        }
        return this;
    }
